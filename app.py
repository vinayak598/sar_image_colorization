...
def colorizer(img):
    ...
    prototxt = r"C:\Users\User\Desktop\color1\models\models_colorization_deploy_v2.prototxt"
    model = r"C:\Users\User\Desktop\color1\models\colorization_release_v2.caffemodel"
    points = r"C:\Users\User\Desktop\color1\models\pts_in_hull.npy"
...
st.write("This app transforms your gray scale images into vibrant, colorized versions.")
st.write("Developed on Thursday, 23 December 2024 (IST) \n by JVR Vinayak.")
